describe('Angular-dynamic-number basic', function() {
  ...
  describe('directive', function(){
    ...
    describe('number format: 2 integers, decimals dot separator, positive and negative', function() {
      ...
      it('should have view value 0 and model value 0 when set 00.11', function () {
    ...
    describe('custom strategy provider', function(){
      ...
      it('should have view value 1,111 and model value 1111 when set 11,11', function () {
        $scope.testForm.testInput.$setViewValue('11,11');
        expect($scope.testInput).toEqual(1111);
        expect($scope.testForm.testInput.$viewValue).toEqual('1,111');
      });
    });
  });
