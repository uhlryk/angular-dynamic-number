describe('Angular-dynamic-number basic', function() {
  ...
  describe('directive', function(){
    ...
    describe('test init values where type="tel"', function() {
      it('should have view value "" and model value "" when init value is ""', function () {
        $scope.testInput = "";
        $compile('<form name="testForm"><input type="tel" name="testInput" ng-model="testInput" awnum/></form>')($scope);
        $scope.$digest();
    ...
    describe('number format: 2 integeres, decimals dot separator, positive and negative', function() {
      beforeEach(function(){
        $compile('<form name="testForm"><input type="tel" name="testInput" ng-model="testInput" awnum num-int="2" num-sep="." num-fract="2"/></form>')($scope);
        $scope.$digest();
      });
      ...
      it('should have view value 0.11 and model value 0.11 when set 00.11', function () {
    ...
    describe('number format: 2 integeres, decimals comma separator, positive and negative', function() {
      beforeEach(function(){
        var el = $compile('<form name="testForm"><input type="tel" name="testInput" ng-model="testInput" awnum num-int="2" num-sep="," num-fract="2"/></form>')($scope);
        $scope.$digest();
      });
      it('should have view value 11,11 and model value 11.11 when set 11,11', function () {
        $scope.testForm.testInput.$setViewValue('11,11');
      ...
      it('should not have view value 0 and model value 0 when set 11.11', function () {
        $scope.testForm.testInput.$setViewValue('11.11');
        expect($scope.testInput).toEqual(null);
        expect($scope.testForm.testInput.$viewValue).toEqual('');
      });
    ...
    describe('number format: 2 integeres, decimals comma separator, positive and negative, dot thousand separator', function() {
      beforeEach(function(){
        var el = $compile('<form name="testForm"><input type="tel" name="testInput" ng-model="testInput" awnum num-int="8" num-sep="," num-fract="2" num-thousand="true"/></form>')($scope);
        $scope.$digest();
      });
    ...
    describe('number format: 2 integeres, decimals comma separator, negative', function() {
      beforeEach(function(){
        var el = $compile('<form name="testForm"><input type="tel" name="testInput" ng-model="testInput" awnum num-int="2" num-sep="," num-fract="2" num-pos="false"/></form>')($scope);
        $scope.$digest();
      });
      it('should have view value 0 and model value 0 when set 11,11', function () {
        $scope.testForm.testInput.$setViewValue('11,11');
    ...
    describe('number format: 6 integeres, decimals dot separator, positive and negative, space thousand separator', function() {
      beforeEach(function(){
        var el = $compile('<form name="testForm"><input type="tel" name="testInput" ng-model="testInput" awnum num-int="8" num-sep="." num-fract="2" num-thousand="true"  num-thousand-sep="{{\' \'}}"/></form>')($scope);
        $scope.$digest();
      });
      it('should have view value 111 111.11 and model value 111111.11 when set 111 111.11', function () {
        $scope.testForm.testInput.$setViewValue('111 111.11');
    ...
    describe('custom strategy provider', function(){
      beforeEach(function(){
        ...
        var el = $compile('<form name="testForm"><input type="tel" name="testInput" ng-model="testInput" awnum="price"/></form>')($scope);
        $scope.$digest();
      });
      it('should have view value 11.11 and model value 11.11 when set 11.11', function () {
        $scope.testForm.testInput.$setViewValue('11.11');
